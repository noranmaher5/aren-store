...
exports.createProduct = async (req, res, next) => {
  try {
    ...
    if (typeof productData.manualRequest === 'string') {
      try { productData.manualRequest = JSON.parse(productData.manualRequest); } catch { productData.manualRequest = { enabled: false }; }
    }
